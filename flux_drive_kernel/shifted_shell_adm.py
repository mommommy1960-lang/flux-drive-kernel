...
This module freezes the static lapse and spatial metric, prescribes a
contravariant shift along the Cartesian x direction, and reconstructs the
complete four-metric from

    g_00 = -alpha**2 + gamma_ij beta**i beta**j
    g_0i = gamma_ij beta**j
    g_ij = gamma_ij.

It is an intentionally independent convention check on the direct-g01
