...
class Budget:
    ...
    def validate(self) -> None:
        ...
        if abs(self.input_power_w - accounted) > tolerance:
            raise ValueError("power ledger does not close")
...
def required_vertical_lift(mass_kg: float, vertical_acceleration_m_s2: float = 0.0) -> float:
    """Force required to hover/lift near Earth; not a propulsion claim."""
